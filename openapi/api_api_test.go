...
func TestVerifierAPIAuthenticationResponse(t *testing.T) {
	...
	tests := []test{
		{"If a same-device flow is authenticated, a valid redirect should be returned.", true, "my-state", getValidVPToken(), nil, verifier.SameDeviceResponse{"http://my-verifier.org", "my-code", "my-session-id"}, 302, "http://my-verifier.org?state=my-session-id&code=my-code", ErrorMessage{}},
...
func getValidVPToken() string {
	return ""
}
